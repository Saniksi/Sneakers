function Header() {
  return (
    <header className="d-flex justify-between align-center p-40">
      ...
      <ul className="d-flex">
        <li className="mr-30">
          {/* так вказуємо картинку якщо не потрібно міняти колір svg для кешування картинки */}
          <img src="/img/cart.svg" alt="Icon Cart" />
          <span className="ml-10">1205 руб.</span>
        </li>
        <li>
          {/* так вказуємо svg картинку коли потрібно змінювати колір іконки */}
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
